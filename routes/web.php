...
// Using Areas Routes
Route::get('/admin/markets', 'App\Http\Controllers\Admin\MarketController@index')->name('admin.markets.index');
Route::get('/admin/markets/create', 'App\Http\Controllers\Admin\MarketController@create')->name('admin.markets.create');
Route::post('/admin/markets/store', 'App\Http\Controllers\Admin\MarketController@store')->name('admin.markets.store');
Route::get('/admin/markets/{id}/edit', 'App\Http\Controllers\Admin\MarketController@edit')->name('admin.markets.edit');
Route::delete('/admin/markets/{id}', 'App\Http\Controllers\Admin\MarketController@destroy')->name('admin.markets.destroy');

// Using Areas Gallery routes
Route::get('/admin/markets/{id}/gallery', 'App\Http\Controllers\Admin\MarketController@galleryIndex')->name('admin.markets.gallery.index');
Route::get('/admin/markets/{id}/gallery/create', 'App\Http\Controllers\Admin\MarketController@galleryCreate')->name('admin.markets.gallery.create');
Route::post('/admin/markets/{id}/gallery/store', 'App\Http\Controllers\Admin\MarketController@galleryStore')->name('admin.markets.gallery.store');
Route::get('/admin/markets/{id}/gallery/{imageId}/edit', 'App\Http\Controllers\Admin\MarketController@galleryEdit')->name('admin.markets.gallery.edit');
Route::delete('/admin/markets/{id}/gallery/{imageId}', 'App\Http\Controllers\Admin\MarketController@galleryDestroy')->name('admin.markets.gallery.destroy');

// Market faq routes
Route::get('/admin/markets/{id}/faq', 'App\Http\Controllers\Admin\MarketController@faqIndex')->name('admin.markets.faq.index');
Route::get('/admin/markets/{id}/faq/create', 'App\Http\Controllers\Admin\MarketController@faqCreate')->name('admin.markets.faq.create');
Route::post('/admin/markets/{id}/faq/store', 'App\Http\Controllers\Admin\MarketController@faqStore')->name('admin.markets.faq.store');
Route::get('/admin/markets/{id}/faq/{faqId}/edit', 'App\Http\Controllers\Admin\MarketController@faqEdit')->name('admin.markets.faq.edit');
Route::delete('/admin/markets/{id}/faq/{faqId}', 'App\Http\Controllers\Admin\MarketController@faqDestroy')->name('admin.markets.faq.destroy');
