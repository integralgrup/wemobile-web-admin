...
@endphp
<?php $pt = 'Anasayfa'; ?>
<?php $mc = 'is-transparent';?>
@extends('layouts.main')

@section('content')
<?php
// KULLANIM ALANI: header.php


// KULLANIM ALANI: footer.php


// KULLANIM ALANI: product-item.php, products.php, product-detail.php


// KULLANIM ALANI: market-detail.php
$marketProducts = [
    [
        "image" => "assets/image/other/market-1.jpg",
        "category" => "Market",
        "category-link" => "products.php",
        "title" => "Sports Events",
        "title-link" => "product-detail.php",
    ],
    [
        "image" => "assets/image/other/market-1.jpg",
        "category" => "Market",
...
// KULLANIM ALANI: products.php
$productSidebar = [
    [
        "title" => "Mobile Hospitals",
        "widget-list" => [
            ["title" => "Mobile Field Hospitals", "count" => "3",],
            ["title" => "Mobile Clinics", "count" => "4",],
            ["title" => "Mobile Health Screening Solutions", "count" => "2",],
            ["title" => "Mobile Blood Donation Solutions", "count" => "4",],
        ],
    ],
    [
        "title" => "Mobile Military",
        "widget-list" => [
            ["title" => "Mobile Command & Coordination Centers", "count" => "3",],
            ["title" => "Mobile Military Kitchen Unit", "count" => "4",],
            ["title" => "Mobile Military Field Hospital", "count" => "2",],
            ["title" => "Mobile Military Dormitory", "count" => "4",],
            ["title" => "Mobile Military Kitchen Unit", "count" => "4",],
            ["title" => "Mobile Military Field Hospital", "count" => "4",],
            ["title" => "Mobile Military Dormitory", "count" => "4",],
        ],
    ],
    [
        "title" => "Mobile Grandstands",
        "widget-list" => [
            ["title" => "Mobile Field Hospitals", "count" => "3",],
            ["title" => "Mobile Clinics", "count" => "4",],
            ["title" => "Mobile Health Screening Solutions", "count" => "2",],
    ...
    [
        "title" => "Special Purpose Mobile Tennis",
        "widget-list" => [
            ["title" => "Mobile Field Hospitals", "count" => "3",],
            ["title" => "Mobile Clinics", "count" => "4",],
            ["title" => "Mobile Health Screening Solutions", "count" => "2",],
...
// KULLANIM ALANI: faq.php
$faq = [
    [
        "title" => "1. On which floors and in which weather conditions is the Decorative Grass Carpet suitable?",
        "expo" => '<p style="color: #FFFFFF;">It offers high quality medical imaging services with state-of-the-art devices and expert staff. The aim of the center is to obtain clear, sharp and high-resolution images so that patients can receive the most accurate diagnosis and treatment. Customer satisfaction has always been adopted as the primary goal and is tailored to the needs of patients.</p>',
    ],
    [
        "title" => "2. Is there a guarantee of Decorative Grass Carpet?",
        "expo" => '<p style="color: #FFFFFF;">It offers high quality medical imaging services with state-of-the-art devices and expert staff. The aim of the center is to obtain clear, sharp and high-resolution images so that patients can receive the most accurate diagnosis and treatment. Customer satisfaction has always been adopted as the primary goal and is tailored to the needs of patients.</p>',
    ],
    [
        "title" => "3. Are there color options for Decorative Grass Carpet?",
        "expo" => '<p style="color: #FFFFFF;">It offers high quality medical imaging services with state-of-the-art devices and expert staff. The aim of the center is to obtain clear, sharp and high-resolution images so that patients can receive the most accurate diagnosis and treatment. Customer satisfaction has always been adopted as the primary goal and is tailored to the needs of patients.</p>',
    ],
    [
        "title" => "4. What are the storage conditions for Decorative Grass Carpet?",
        "expo" => '<p style="color: #FFFFFF;">It offers high quality medical imaging services with state-of-the-art devices and expert staff. The aim of the center is to obtain clear, sharp and high-resolution images so that patients can receive the most accurate diagnosis and treatment. Customer satisfaction has always been adopted as the primary goal and is tailored to the needs of patients.</p>',
    ],
];
...
// KULLANIM ALANI: index.php
$homepageProducts = [
    [
        "title" => "Mobile Hospitals",
        "content" => [
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile CT & MRI Clinic Trailer Vehicle",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Surgical Trailer Unit",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Intensive Care (ICU) Trailer Unit",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Mutli Clinic",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Clinic Container Truck Trailer",
                "link" => "product-detail.php",
            ],
        ],
    ],
    [
        ...
        "content" => [
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Military CT & MRI Clinic Trailer Vehicle",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Military Surgical Trailer Unit",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Military Intensive Care (ICU) Trailer Unit",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Military Mutli Clinic",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Military Clinic Container Truck Trailer",
                "link" => "product-detail.php",
            ],
        ],
    ],
    [
        ...
        "content" => [
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Grandstands CT & MRI Clinic Trailer Vehicle",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Grandstands Surgical Trailer Unit",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Grandstands Intensive Care (ICU) Trailer Unit",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Grandstands Mutli Clinic",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Grandstands Clinic Container Truck Trailer",
                "link" => "product-detail.php",
            ],
        ],
    ],
    [
        ...
        "content" => [
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Stage Systems CT & MRI Clinic Trailer Vehicle",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Stage Systems Surgical Trailer Unit",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Stage Systems Intensive Care (ICU) Trailer Unit",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Stage Systems Mutli Clinic",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Mobile Stage Systems Clinic Container Truck Trailer",
                "link" => "product-detail.php",
            ],
        ],
    ],
    [
        ...
        "content" => [
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Caravan CT & MRI Clinic Trailer Vehicle",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Caravan Surgical Trailer Unit",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Caravan Intensive Care (ICU) Trailer Unit",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Caravan Mutli Clinic",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Caravan Clinic Container Truck Trailer",
                "link" => "product-detail.php",
            ],
        ],
    ],
    [
        ...
        "content" => [
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Special Purpose Mobile Tennis CT & MRI Clinic Trailer Vehicle",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Special Purpose Mobile Tennis Surgical Trailer Unit",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Special Purpose Mobile Tennis Intensive Care (ICU) Trailer Unit",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Special Purpose Mobile Tennis Mutli Clinic",
                "link" => "product-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.png",
                "image-backgrond" => "assets/image/other/product-1-bg.jpg",
                "title" => "Special Purpose Mobile Tennis Clinic Container Truck Trailer",
                "link" => "product-detail.php",
            ],
        ],
    ],
];
// KULLANIM ALANI: project-detail.php
$otherProject = [
    [
        "image" => "assets/image/other/product-1.jpg",
        "category" => "Cyprus",
        "category-link" => "projects.php",
        "title" => "Cyprus Origin Discover Padel Construction",
        "title-link" => "project-detail.php",
    ],
    [
        "image" => "assets/image/other/product-2.jpg",
        "category" => "Cyprus",
        "category-link" => "projects.php",
        "title" => "Cyprus Origin Discover Padel Construction",
        "title-link" => "project-detail.php",
...
// KULLANIM ALANI: index.php, projects.php
$worldMap = [
    [
        ...
        "content" => [
            [
                "image" => "assets/image/other/product-1.jpg",
                "location" => "Russia",
                "title" => "Russia Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.jpg",
                "location" => "Ozbekistan",
                "title" => "Ozbekistan Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.jpg",
                "location" => "China",
                "title" => "China Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.jpg",
    ...
    [
        ...
        "content" => [
            [
                "image" => "assets/image/other/product-1.jpg",
                "location" => "England",
                "title" => "England Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.jpg",
                "location" => "France",
                "title" => "France Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.jpg",
                "location" => "Spain",
                "title" => "Spain Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.jpg",
                "location" => "Italy",
                "title" => "Italy Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.jpg",
    ...
    [
        ...
        "content" => [
            [
                "image" => "assets/image/other/product-1.jpg",
                "location" => "Nigeria",
                "title" => "Nigeria Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.jpg",
                "location" => "Madagascar",
                "title" => "Madagascar Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.jpg",
                "location" => "Egypt",
                "title" => "Egypt Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.jpg",
    ...
    [
        ...
        "content" => [
            [
                "image" => "assets/image/other/product-1.jpg",
                "location" => "U.S.A.",
                "title" => "U.S.A. Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.jpg",
                "location" => "Canada",
                "title" => "Canada Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.jpg",
                "location" => "Mexico",
                "title" => "Mexico Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.jpg",
    ...
    [
        ...
        "content" => [
            [
                "image" => "assets/image/other/product-1.jpg",
                "location" => "Brasil",
                "title" => "Brasil Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-2.jpg",
                "location" => "Peru",
                "title" => "Peru Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.jpg",
                "location" => "Argentina",
                "title" => "Argentina Origin Discover Padel Construction",
                "link" => "project-detail.php",
            ],
            [
                "image" => "assets/image/other/product-1.jpg",
...
<main class="main-field relative">
    <!-- CAROUSEL -->
    <section class="carousel-section relative h-dvh sm:h-auto">
        <div class="background bg-main-500 absolute top-0 left-0 w-full h-full z-2 translate-z-0 pointer-events-none">
            <div class="image w-full h-full overflow-hidden translate-z-0">
                <img src="assets/image/other/homepage-background.png" class="full-cover !object-left" alt="">
            </div>
        </div>
        <div class="carousel-field relative h-full z-20">
            <div class="container max-w-[1500px] h-full md:px-0">
                <div class="carousel-wrapper homepage-carousel-wrapper grid grid-cols-[minmax(0,5.6fr)_minmax(0,6.8fr)] gap-[120px] 2xl:gap-[80px] xl:gap-[60px] lg:gap-[45px] md:gap-[30px] md:grid-cols-1 h-full">
                    <div class="homepage-text-carousel-field">
                        <div class="homepage-carousel swiper h-full">
                            <div class="swiper-wrapper">
                                <?php foreach ($slides as $key => $slide) : ?>
                                    <div class="swiper-slide group/slide">
                                        <div class="content relative h-full pointer-events-none">
                                            <div class="text-container container max-w-[1500px] h-full px-0 md:px-[30px]">
                                                <div class="text-wrapper homepage-text-wrapper flex flex-col justify-center h-full max-w-[560px] pt-[var(--header-height)] xl:pt-[calc(var(--header-height)+30px+30px)] pointer-events-auto md:pt-[var(--header-height)] md:pb-[130px] md:max-w-full z-20 relative
                                                sm:pt-[calc(var(--header-height)+50px)]
                                                sm:pb-[calc(50px+50px)]
                                                ">
                                                    <div class="title-field flex flex-col gap-[30px]">
                                                        <p class="text small-text text-[18px] md:text-[16px] leading-tight text-white tracking-[0.15rem] font-medium line-clamp-1">{{$slide->slide_title}}</p>
                                                        <h2 class="text text-[48px] 2xl:text-[42px] xl:text-[36px] lg:text-[28px] md:text-[24px] sm:text-[20px] leading-tight text-white font-bold md:[&_br]:hidden line-clamp-2">{{$slide->title_1}}</h2>
                                                    </div>
                                                    <div class="editor-field mt-[30px] lg:mt-[20px] md:mt-[15px]">
                                                        <div class="text-editor !max-w-full editor-p:text-[18px] editor-li:text-[18px] md:editor-p:text-[18px] md:editor-li:text-[18px] sm:editor-p:text-[16px] sm:editor-li:text-[16px] xs:editor-p:text-[14px] xs:editor-li:text-[14px] [&_>*]:hidden [&_>*:first-child]:line-clamp-2">
                                                            <p style="color: #FFFFFF;">{{$slide->descrititle_2ption}}</p>
                                                        </div>
                                                    </div>
                                                    <div class="button-field mt-[50px] xl:mt-[40px] lg:mt-[30px] md:mt-[20px]">
                                                        <a href="about.php" class="button w-fit h-[50px] flex items-center justify-center min-w-[185px] px-[50px] bg-white/15 relative gap-[15px] duration-350 overflow-hidden hover:bg-main-600 group/button">
                                                            <div class="text text-[17px] lg:text-[16px] font-semibold flex items-center text-white relative z-2">{{$slide->button_title}}</div>
                                                            <div class="icon-chevron-right text-[8px] h-[8px] flex items-center text-white relative z-2 mt-[2px] duration-350 group-hover/button:translate-x-[4px] rtl:rotate-180 rtl:group-hover/button:translate-x-[-4px]"></div>
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="image-field hidden md:block absolute right-0 top-[var(--header-height)] w-full h-[calc(100%-var(--header-height))] opacity-20">
                                                    <div class="image w-full h-full overflow-hidden translate-z-0">
                                                        <img src="{{  env('HTTP_DOMAIN') . '/' .getFolder(['uploads_folder', 'images_folder'], $slide->lang ). '/'. $slide->image }}" class="full-contain !object-left-bottom" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="carousel-controller md:px-[30px]">
                            <div class="carousel-controller-wrapper grid grid-cols-[minmax(0,1fr)_minmax(0,1fr)] gap-[200px] 2xl:gap-[80px] xl:gap-[60px] lg:gap-[45px] md:gap-[30px] md:grid-cols-1 relative z-50">
                                <div class="carousel-controller-content absolute bottom-0 md:bottom-[30px] left-0 translate-x-0 flex gap-[25px] xl:gap-[20px] lg:gap-[15px] md:gap-[10px] items-end w-full justify-between md:justify-center">
                                    <div class="carousel-pagination flex justify-start z-20 ">
                                        <div class="homepage-pagination flex justify-start gap-[25px] xl:gap-[20px] lg:gap-[15px] md:gap-[10px] [&_.swiper-pagination-bullet]:w-[14px] [&_.swiper-pagination-bullet]:h-[14px] [&_.swiper-pagination-bullet]:!m-0 [&_.swiper-pagination-bullet]:bg-white/15 [&_.swiper-pagination-bullet]:!rounded-none [&_.swiper-pagination-bullet]:opacity-100 [&_.swiper-pagination-bullet]:duration-350 [&_.swiper-pagination-bullet-active]:!bg-white"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="scroll-wrapper-pagination hidden 2xl:block absolute left-1/2 -translate-x-1/2 md:bottom-[30px] z-50 md:hidden">
                                <div class="scroll-down-field flex flex-col items-center gap-[12px] cursor-pointer group/scroll scrollable-selector" data-scrollable-section=".about-section">
                                    <div class="icon-field">
                                        <svg class="w-[24px] h-[37px]" viewBox="0 0 24 37" xmlns="http://www.w3.org/2000/svg">
                                            <path class="fill-none stroke-white [stroke-width:2px]" d="M12.3252 1.68213H12.3238C6.44954 1.68213 1.6875 6.44417 1.6875 12.3184V24.77C1.6875 30.6442 6.44954 35.4063 12.3238 35.4063H12.3252C18.1994 35.4063 22.9615 30.6442 22.9615 24.77V12.3184C22.9615 6.44417 18.1994 1.68213 12.3252 1.68213Z" />
                                            <path class="fill-white duration-350 group-hover/scroll:translate-y-[13px]" d="M13.4553 8.92395C13.4553 8.29879 12.9485 7.79199 12.3234 7.79199C11.6982 7.79199 11.1914 8.29879 11.1914 8.92395V13.4518C11.1914 14.0769 11.6982 14.5837 12.3234 14.5837C12.9485 14.5837 13.4553 14.0769 13.4553 13.4518V8.92395Z" />
                                        </svg>
                                    </div>
                                    <div class="text-field">
                                        <p class="text text-[15px] font-medium leading-tight text-white">Scroll</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="homepage-image-carousel-field relative overflow-hidden md:hidden">
                        <div class="homepage-image-carousel swiper h-full animate-carousel">
                            <div class="swiper-wrapper">
                                <?php foreach ($slides as $key => $slide) : ?>
                                    <div class="swiper-slide group/slide">
                                        <div class="content relative h-full">
                                            <div class="image-field homepage-image-wrapper relative translate-z-0 h-full pt-[calc(var(--header-height)+130px)] 2xl:pt-[calc(var(--header-height)+80px)] xl:pt-[calc(var(--header-height)+30px)] pointer-events-none rtl:-scale-x-100">
                                                <div class="image h-full overflow-hidden translate-z-0">
                                                    <img src="{{  env('HTTP_DOMAIN') . '/' .getFolder(['uploads_folder', 'images_folder'], $slide->lang ). '/'. $slide->image }}" class="full-contain !object-right-bottom" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="scroll-wrapper absolute left-0 bottom-[30px] z-20 -translate-x-1/2 2xl:hidden">
                    <div class="scroll-down-field flex flex-col items-center gap-[12px] cursor-pointer group/scroll scrollable-selector" data-scrollable-section=".about-section">
                        <div class="icon-field">
                            <svg class="w-[24px] h-[37px]" viewBox="0 0 24 37" xmlns="http://www.w3.org/2000/svg">
                                <path class="fill-none stroke-white [stroke-width:2px]" d="M12.3252 1.68213H12.3238C6.44954 1.68213 1.6875 6.44417 1.6875 12.3184V24.77C1.6875 30.6442 6.44954 35.4063 12.3238 35.4063H12.3252C18.1994 35.4063 22.9615 30.6442 22.9615 24.77V12.3184C22.9615 6.44417 18.1994 1.68213 12.3252 1.68213Z" />
    ...
    <!-- ABOUT -->
    <section class="about-section pb-[130px] 2xl:pb-[80px] xl:pb-[60px] lg:pb-[45px] md:py-[30px] relative overflow-hidden">
        <div class="container max-w-[1500px] relative z-20">
            <div class="wrapper relative z-20">
                <div class="about-background bg-[#FFFAFA] absolute top-0 left-0 w-full h-full z-2 translate-z-0 pointer-events-none"></div>
                <div class="about-inner-wrapper relative z-20 pl-[100px] 2xl:pl-[80px] xl:pl-[60px] lg:pl-[45px] md:pl-0 grid grid-cols-[minmax(0,9fr)_minmax(0,5.5fr)] gap-0 md:grid-cols-1">
                    <div class="about-iconable-field col-span-2 md:col-span-1 relative z-20 pt-[70px] 2xl:pt-[70px] xl:pt-[60px] lg:pt-[45px] md:pt-[30px]">
                        <?php $list = [
                            [
                                "icon" => "assets/image/icon/icon-25.png",
                                "title" => "Professional<br> Service",
                            ],
                            [
                                "icon" => "assets/image/icon/icon-25.png",
                                "title" => "Professional<br> Service",
                        ...
                        <ul class="grid grid-cols-4 gap-[100px] 2xl:gap-[80px] xl:gap-[60px] lg:gap-[45px] md:gap-[30px] sm:grid-cols-2 sm:gap-[15px]">
                            <?php foreach ($list as $key => $item) : ?>
                                <li class="group/item">
                                    <div class="content-wrapper flex items-center gap-[35px] xl:gap-[30px] lg:gap-[20px] xs:gap-[15px]">
                                        <div class="icon-field shrink-0">
                                            <div class="image aspect-[85/78] max-w-[85px] sm:max-w-[50px] xs:max-w-[30px] w-full overflow-hidden translate-z-0 shrink-0">
                                                <img src="<?= $item['icon'] ?>" class="full-contain grayscale duration-350 group-hover/item:grayscale-0" alt="">
                                            </div>
                                        </div>
                                        <div class="text-field flex flex-col gap-[15px]">
                                            <p class="text text-[20px] lg:text-[18px] md:text-[16px] xs:text-[14px] leading-tight text-[#818181] sm:[&_br]:hidden duration-350 group-hover/item:text-main-500"><?= $item['title'] ?></p>
                                        </div>
                                    </div>
                                </li>
                            <?php endforeach; ?>
                    ...
                    <div class="about-text-field mt-[100px] mb-[75px] 2xl:mt-[80px] xl:my-[60px] lg:my-[45px] md:my-[30px] relative z-20">
                        <div class="content flex flex-col gap-[20px] md:gap-[15px]">
                            <p class="text small-text text-[18px] md:text-[16px] leading-tight text-main-500 tracking-[0.15rem] font-medium">{{$about->upper_title}}</p>
                            <h2 class="text text-[48px] 2xl:text-[42px] xl:text-[36px] lg:text-[28px] md:text-[24px] sm:text-[20px] leading-tight text-[#1E1E1E] font-semibold md:[&_br]:hidden">{{$about->title}}</h2>
                            <div class="text-editor !max-w-full editor-p:text-[20px] editor-li:text-[20px] md:editor-p:text-[18px] md:editor-li:text-[18px] sm:editor-p:text-[16px] sm:editor-li:text-[16px] xs:editor-p:text-[14px] xs:editor-li:text-[14px]">
                                ...
                                <p style="color: #676767;">{{$about->description}}</p>
                            </div>
                            <div class="button-field">
                                <a href="{{env('HTTP_DOMAIN') . '/' . $about->button_url}}" class="button group/button w-fit min-w-[185px] h-[50px] md:h-[50px] flex justify-center items-center gap-[10px] px-[30px] rounded-none bg-transparent relative duration-350 overflow-hidden hover:bg-main-600 sm:w-full border border-solid border-main-500 hover:border-main-600">
                                    <span class="text text-[17px] flex items-center text-main-500 relative z-10 leading-tight duration-350 group-hover/button:text-white font-medium">{{$about->button_text}}</span>
                                    <i class="icon icon-chevron-right text-[8px] h-[8px] text-main-500 leading-none flex items-center relative z-10 duration-350 group-hover/button:text-white group-hover/button:translate-x-[4px] rtl:rotate-180 rtl:group-hover/button:translate-x-[-4px]"></i>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="about-image-field-fixer"></div>
                    <div class="about-image-field absolute h-full top-0 right-0 md:opacity-50">
                        <div class="image aspect-[745/730] w-full h-full overflow-hidden translate-z-0">
                            <img src="assets/image/other/homepage-about.png" class="full-cover !object-left-top md:!object-left" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="wrapper flex flex-col gap-[60px] lg:gap-[45px] md:gap-[30px]">
                ...
                <div class="carousel-field relative">
                    <div class="certificates-carousel swiper">
                        <div class="swiper-wrapper">
                            <?php foreach ($about_certificates as $i => $item) : ?>
                                <div class="swiper-slide group/slide">
                                    <div class="content relative">
                                        <div class="image-field relative translate-z-0">
                                            <a href="javascript:;" class="image group/image aspect-[280/65] max-w-[280px] max-h-[65px] sm:aspect-[220/100] sm:max-h-[100px] w-full h-full overflow-hidden translate-z-0 flex items-center justify-center">
                                                ...
                                                <img src="{{  env('HTTP_DOMAIN') . '/' .getFolder(['uploads_folder', 'images_folder'], $item->lang ). '/'. $item->image }}" class="full-contain max-h-[calc(65px+5px)] sm:max-h-[calc(100px+5px)] duration-350 grayscale group-hover/image:grayscale-0 group-hover/image:-translate-y-[5px] opacity-60 group-hover/image:opacity-100 pt-[5px]" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- PRODUCTS -->
    <section class="products-section pb-[100px] 2xl:pb-[80px] xl:pb-[60px] lg:pb-[45px] md:pb-[30px] relative">
        <div class="container max-w-[1500px]">
            <div class="wrapper">
                <div class="text-field flex gap-[15px] justify-between md:flex-col md:justify-start mb-[70px] md:mb-[30px]">
                    <div class="content flex flex-col gap-[20px] md:gap-[15px]">
                        <p class="text small-text text-[18px] md:text-[16px] leading-tight text-main-500 tracking-[0.15rem] font-medium">Products</p>
                        <h2 class="text text-[48px] 2xl:text-[42px] xl:text-[36px] lg:text-[28px] md:text-[24px] sm:text-[20px] leading-tight text-[#1E1E1E] font-semibold md:[&_br]:hidden">Mobile Hospital, Mobile Clinic</h2>
                        <p class="expo text-[18px] md:text-[16px] leading-tight text-[#676767]">Wemobile is a leading company that produces healthcare vehicles.</p>
                    </div>
                    <div class="filter-field flex items-end md:w-full">
                        <div class="wrapper flex items-center gap-[20px] md:flex-col md:w-full md:items-start">
                            <div class="text-field">
                                <p class="text text-[20px] lg:text-[18px] md:text-[16px] leading-tight font-semibold text-[#676767]">Filter:</p>
                            </div>
                            <div class="custom-select relative group/select min-w-[425px] w-full md:min-w-full">
                                <select name="homepage-product-tab-selector" id="homepage-product-tab-selector" class="w-full h-[70px] lg:h-[50px] border border-solid border-black/16 duration-350 group-hover/select:border-black bg-bodyColor text-black pl-[30px] pr-[45px] rtl:pl-[45px] rtl:pr-[30px]">
                                    <?php foreach ($homepageProducts as $key => $item) : ?>
                ...
                <div class="product-list-field">
                    <?php foreach ($homepageProducts as $key => $item) : ?>
                        <div class="product-list-wrapper hidden [&.is-active]:block md:!hidden">
                            <div class="wrapper grid grid-cols-3 gap-[1px] bg-black/10">
                                <?php foreach ($products as $key => $content) : ?>
                                    <div class="item product-item relative group/item hover:z-20">
                                        <div class="content bg-bodyColor duration-350 min-md:group-hover/item:scale-115 h-full min-md:group-hover/item:shadow-[0px_25px_100px_0px_rgba(0,0,0,0.15)]">
                                            <div class="image-field relative">
                                                <div class="background absolute top-0 left-0 w-full h-full z-2 translate-z-0 opacity-0 duration-350 group-hover/item:opacity-100">
                                                    <div class="image w-full h-full overflow-hidden translate-z-0">
                                                        <img src="{{  env('HTTP_DOMAIN') . '/' .getFolder(['uploads_folder', 'product_images_folder'], $content->lang ). '/'. $content->image }}" class="full-cover" alt="">
                                                    </div>
                                                </div>
                                                <a href="<?= $content['seo_url'] ?>" class="flex items-center justify-center image aspect-[395/240] max-w-[395px] w-full mx-auto overflow-hidden translate-z-0 relative z-20">
                                                    <img src="{{  env('HTTP_DOMAIN') . '/' .getFolder(['uploads_folder', 'product_images_folder'], $content->lang ). '/'. $content->image }}" class="full-contain" alt="">
                                                </a>
                                            </div>
                                            <div class="text-field p-[30px] md:p-[20px]">
                                                <a href="<?= $content['seo_url'] ?>" class="flex justify-center text text-[22px] lg:text-[20px] md:text-[18px] leading-tight text-[#454545] text-center duration-350 hover:text-main-600 [-webkit-text-stroke:0.5px_transparent] hover:[-webkit-text-stroke:0.5px_var(--main-500)]"><?= $content['title'] ?></a>
                                                <div class="button-field flex justify-center mt-[20px] lg:mt-[15px] duration-350 overflow-hidden opacity-0 group-hover/item:opacity-100">
                                                    <a href="<?= $content['seo_url'] ?>" class="button group/button w-full h-[50px] md:h-[50px] flex justify-center items-center gap-[10px] px-[30px] rounded-0 bg-main-500 relative duration-350 overflow-hidden hover:bg-main-500 sm:w-full border border-solid border-main-500 hover:border-main-600">
                                                        <span class="text text-[16px] flex items-center text-white relative z-10 leading-tight duration-350 group-hover/button:text-white">View</span>
                                                        <i class="icon icon-chevron-right text-[8px] h-[8px] text-white leading-none flex items-center relative z-10 duration-350 group-hover/button:text-white group-hover/button:translate-x-[4px] rtl:rotate-180 rtl:group-hover/button:translate-x-[-4px]"></i>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <?php endforeach; ?>
                                <div class="button-field flex items-center justify-center bg-bodyColor">
                                    <div class="content flex flex-col items-center justify-center gap-[30px] lg:gap-[20px]">
                                        <p class="text text-[26px] 2xl:text-[24px] xl:text-[22px] lg:text-[20px] leading-tight font-semibold text-center text-[#1E1E1E]">View All Products Now</p>
                                        <a href="products.php" class="button group/button w-fit min-w-[185px] h-[60px] md:h-[50px] flex justify-center items-center gap-[10px] px-[30px] rounded-0 bg-bodyColor relative duration-350 overflow-hidden hover:bg-main-500 sm:w-full border border-solid border-main-500 hover:border-main-600">
                                            <span class="text text-[16px] flex items-center text-main-500 relative z-10 leading-tight duration-350 group-hover/button:text-white">View</span>
                                            <i class="icon icon-chevron-right text-[8px] h-[8px] text-main-500 leading-none flex items-center relative z-10 duration-350 group-hover/button:text-white group-hover/button:translate-x-[4px] rtl:rotate-180 rtl:group-hover/button:translate-x-[-4px]"></i>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="mobile-view-product hidden md:[&.is-active]:block">
                            <div class="carousel-field relative">
                                <div class="homepage-product-carousel swiper animate-carousel">
                                    <div class="swiper-wrapper">
                                        <?php foreach ($item['content'] as $key => $content) : ?>
                                            <div class="swiper-slide group/slide">
                                                <div class="item product-item relative group/item hover:z-20">
                                                    <div class="content bg-bodyColor duration-350 min-md:group-hover/item:scale-115 h-full border border-solid border-black/10">
                                                        <div class="image-field relative">
                                                            <div class="background absolute top-0 left-0 w-full h-full z-2 translate-z-0 min-md:opacity-0 duration-350 group-hover/item:opacity-100">
                                                                <div class="image w-full h-full overflow-hidden translate-z-0">
                                                                    <img src="assets/image/other/product-1-bg.png" class="full-cover" alt="">
                                                                </div>
                                                            </div>
                                                            <a href="<?= $content['link'] ?>" class="flex items-center justify-center image aspect-[395/240] max-w-[395px] w-full mx-auto overflow-hidden translate-z-0 relative z-20">
                                                                <img src="<?= $content['image'] ?>" class="full-contain" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="text-field p-[30px] md:p-[20px]">
                                                            <a href="<?= $content['link'] ?>" class="flex justify-center text text-[22px] lg:text-[20px] md:text-[18px] leading-tight text-[#454545] text-center duration-350 hover:text-main-600"><?= $content['title'] ?>Unit</a>
                                                            <div class="button-field flex justify-center mt-[20px] lg:mt-[15px] duration-350 overflow-hidden min-md:opacity-0 min-md:group-hover/item:opacity-100">
                                                                <a href="products.php" class="button group/button w-full h-[50px] md:h-[50px] flex justify-center items-center gap-[10px] px-[30px] rounded-0 bg-main-500 relative duration-350 overflow-hidden hover:bg-main-500 sm:w-full border border-solid border-main-500 hover:border-main-600">
                                                                    <span class="text text-[16px] flex items-center text-white relative z-10 leading-tight duration-350 group-hover/button:text-white">View</span>
                                                                    <i class="icon icon-chevron-right text-[8px] h-[8px] text-white leading-none flex items-center relative z-10 duration-350 group-hover/button:text-white group-hover/button:translate-x-[4px]"></i>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="carousel-controller">
                                    <div class="carousel-navigation flex justify-center gap-[20px] md:gap-[15px] sm:gap-[10px] pointer-events-none">
                                        <div class="homepage-product-prev cursor-pointer pointer-events-auto duration-350 [&.swiper-button-disabled]:opacity-50 [&.swiper-button-disabled]:pointer-events-none group/nav-selector">
                                            <div class="icon group/navigation flex items-center justify-center duration-350">
                                                <i class="icon-arrow-left text-main-500 text-[45px] h-[45px] sm:text-[25px] sm:h-[25px] flex items-center justify-center group-[&.swiper-button-disabled]/nav-selector:text-[#676767] group-hover/navigation:text-main-500 duration-350 group-hover/navigation:translate-x-[-3px] rtl:group-hover/navigation:translate-x-[3px] rtl:rotate-180"></i>
                                            </div>
                                        </div>
                                        <div class="homepage-product-next cursor-pointer pointer-events-auto duration-350 [&.swiper-button-disabled]:opacity-50 [&.swiper-button-disabled]:pointer-events-none group/nav-selector">
                                            <div class="icon group/navigation flex items-center justify-center duration-350">
                                                <div class="icon-arrow-right text-main-500 text-[45px] h-[45px] sm:text-[25px] sm:h-[25px] flex items-center justify-center group-[&.swiper-button-disabled]/nav-selector:text-[#676767] group-hover/navigation:text-main-500 duration-350 group-hover/navigation:translate-x-[3px] rtl:group-hover/navigation:translate-x-[-3px] rtl:rotate-180"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- PROJECTS -->
    <section class="projects-section pb-[150px] 2xl:pb-[80px] xl:pb-[60px] lg:pb-[45px] md:pb-[30px] relative">
        <div class="container max-w-[1500px]">
            <div class="wrapper flex flex-col gap-[60px] xl:pb-[45px] lg:pb-[30px] md:pb-[30px] relative lg:gap-[45px] md:gap-[30px] sm:gap-[20px]">
                <div class="text-field flex gap-[15px] justify-between sm:flex-col sm:justify-start">
                    <div class="content flex flex-col gap-[20px] md:gap-[15px]">
                        <p class="text small-text text-[18px] md:text-[16px] leading-none text-main-500 tracking-[0.15rem] font-medium">Projects</p>
                        <h2 class="text text-[48px] 2xl:text-[42px] xl:text-[36px] lg:text-[28px] md:text-[24px] sm:text-[20px] leading-none text-[#1E1E1E] font-semibold md:[&_br]:hidden">Health is With You Everywhere, Every Time!</h2>
                    </div>
                    <div class="link-field flex items-end">
                        <a href="projects.php" class="flex group/link gap-[20px] items-center">
                            <span class="text text-[18px] md:text-[16px] leading-tight text-main-500 duration-350 group-hover/link:text-main-800 tracking-[0.25rem]">VIEW ALL</span>
                            <i class="icon icon-arrow-right text-[39px] h-[39px] text-main-500 block leading-none duration-350 group-hover/link:text-main-800 group-hover/link:translate-x-[3px] rtl:rotate-180 rtl:group-hover/link:translate-x-[-3px]"></i>
                        </a>
                    </div>
                </div>
                <div class="filter-field">
                    <div class="web-view md:hidden">
                        <ul class="grid grid-cols-7 gap-0 justify-between [&_li:last-child_.split]:hidden">
                            <li class="relative">
                                <a href="javascript:;" class="filter-item flex justify-center items-center gap-[8px] group/link [&.is-active]:bg-main-500 h-[56px] lg:h-[50px] px-[30px] 2xl:px-[30px] xl:px-[20px] hover:bg-main-400 duration-350" onclick="allCountry(this)">
                                    <div class="icon w-[8px] h-[8px] rounded-full bg-white opacity-0 duration-350 group-hover/link:opacity-100 group-[&.is-active]/link:opacity-100"></div>
                                    <span class="text text-[18px] leading-tight text-[#1E1E1E] duration-350 group-[&.is-active]/link:text-white group-hover/link:text-white group-[&.is-active]/link:font-semibold">All Country</span>
                                </a>
                                <div class="split w-[1px] h-[30px] bg-black/10 absolute right-0 top-1/2 -translate-y-1/2"></div>
                            </li>
                            <?php foreach ($worldMap as $key => $item) : ?>
                                <li class="relative">
                                    <a href="#popup-project" data-fancybox class="filter-item selectable flex justify-center items-center gap-[8px] group/link [&.is-active]:bg-main-500 h-[56px] lg:h-[50px] px-[30px] 2xl:px-[30px] xl:px-[20px] hover:bg-main-400 duration-350" data-content-id="<?= $key ?>" onclick="popupProjectFunction(this), filterItemFunction(this)">
                                        <div class="icon w-[8px] h-[8px] rounded-full bg-white opacity-0 duration-350 group-hover/link:opacity-100 group-[&.is-active]/link:opacity-100"></div>
                                        <span class="text text-[18px] leading-tight text-[#1E1E1E] duration-350 group-[&.is-active]/link:text-white group-hover/link:text-white group-[&.is-active]/link:font-semibold"><?= $item['title'] ?></span>
                                    </a>
                                    <div class="split w-[1px] h-[30px] bg-black/10 absolute right-0 top-1/2 -translate-y-1/2"></div>
                                </li>
                            <?php endforeach; ?>
                            <li class="relative">
                                <a href="javascript:;" class="filter-item flex justify-center items-center gap-[8px] group/link [&.is-active]:bg-main-500 h-[56px] lg:h-[50px] px-[30px] 2xl:px-[30px] xl:px-[20px] hover:bg-main-400 duration-350">
                                    <div class="icon w-[8px] h-[8px] rounded-full bg-white opacity-0 duration-350 group-hover/link:opacity-100 group-[&.is-active]/link:opacity-100"></div>
                                    <span class="text text-[18px] leading-tight text-[#1E1E1E] duration-350 group-[&.is-active]/link:text-white group-hover/link:text-white group-[&.is-active]/link:font-semibold">Australia</span>
                                </a>
                                <div class="split w-[1px] h-[30px] bg-black/10 absolute right-0 top-1/2 -translate-y-1/2"></div>
                            </li>
                        </ul>
                    ...
                    <div class="mobile-view hidden md:block">
                        <div class="custom-select relative group/select pointer-events-auto">
                            <select name="map-selector" id="map-selector" class="w-full h-[70px] md:h-[50px] border border-solid border-black/10 duration-350 group-hover/select:border-main-500 bg-bodyColor text-black pl-[30px] pr-[60px]">
                                <option value="All Country" data-id="10" selected>All Country</option>
                                <?php foreach ($worldMap as $key => $item) : ?>
                                    <option value="<?= $item['title'] ?>" data-id="<?= $key ?>" class="selectable-option" data-content-id="<?= $key ?>"><?= $item['title'] ?></option>
                                <?php endforeach; ?>
                                <option value="Australia" data-id="11">Australia</option>
                            </select>
                            <div class="icon-field absolute right-[30px] top-1/2 -translate-y-1/2 z-20 pointer-events-none rtl:right-auto rtl:left-[30px]">
                                <i class="icon icon-chevron-bottom text-[12px] h-[12px] text-black/50 block leading-none duration-350"></i>
                            </div>
    ...
    <!-- BLOG -->
    <section class="blog-section pb-[150px] 2xl:pb-[80px] xl:pb-[60px] lg:pb-[45px] md:pb-[30px] relative overflow-hidden">
        <div class="background bg-[#FFFAFA] absolute top-0 left-0 w-[50%] h-full z-2 translate-z-0 md:hidden"></div>
        <div class="section-content py-[100px] 2xl:py-[80px] xl:py-[60px] lg:py-[45px] md:py-0 relative z-20">
            <div class="container max-w-[1500px]">
                <div class="wrapper blog-wrapper grid grid-cols-[minmax(0,4.3fr)_minmax(0,8.8fr)] gap-[120px] 2xl:gap-[80px] xl:gap-[60px] lg:gap-[45px] md:gap-[30px] md:grid-cols-1">
                    <div class="carousel-field relative z-50 py-[60px] xl:py-[45px] lg:py-[30px] md:py-0">
                        <div class="blog-text-background bg-[#FFFAFA] absolute top-0 left-0 w-full h-full z-2 translate-z-0 md:hidden pointer-events-none"></div>
                        <div class="content flex flex-col gap-[20px] md:gap-[15px] relative z-20">
                            <p class="text small-text text-[18px] md:text-[16px] leading-tight text-main-500 tracking-[0.15rem] font-medium">Wemobile</p>
                            <h2 class="text text-[48px] 2xl:text-[42px] xl:text-[36px] lg:text-[28px] md:text-[24px] sm:text-[20px] leading-tight text-[#1E1E1E] font-semibold md:[&_br]:hidden">News & Blog</h2>
                            <div class="line-field w-[30px] h-[4px] mt-[20px] xl:mt-[20px] lg:mt-[10px] md:mt-0">
                                <div class="line w-full h-full bg-main-500"></div>
                            </div>
                        </div>
                        <div class="blog-text-carousel-field md:hidden mt-[40px] xl:mt-[30px] lg:mt-[20px] relative z-20">
                            <div class="blog-text-carousel swiper">
                                <div class="swiper-wrapper">
                                    <!-- SLIDER YAPISININ STABİL ÇALIŞABİLMESİ İÇİN, EN AZ 6 ADET İÇERİK GİRİLMESİ TAVSİYE EDİLİR. -->
                                    <?php foreach ($blog as $key => $item) : ?>
                                        <div class="swiper-slide group/slide">
                                            <div class="content relative overflow-hidden">
                                                <div class="date-field flex items-center gap-[10px] group/date">
                                                    <i class="icon icon-calendar text-[16px] h-[16px] text-[#9A9A9A] block leading-none duration-350 group-hover/date:text-main-500"></i>
                                                    <span class="text text-[15px] text-[#9A9A9A] font-medium leading-tight tracking-[0.02rem] duration-350 group-hover/date:text-main-500"><?= date('j F Y', strtotime($item['created_at'])) ?></span>
                                                </div>
                                                <div class="text-field mt-[15px] lg:mt-[10px]">
                                                    <a href="<?= $item['seo_url'] ?>" class="title flex group/link">
                                                        <span class="text text-[26px] 2xl:text-[24px] xl:text-[22px] lg:text-[20px] font-medium leading-tight text-[#4F4F4F] duration-350 group-hover/link:text-main-500"><?= $item['title'] ?></span>
                                                    </a>
                                                    <div class="editor-field mt-[30px] xl:mt-[20px] lg:mt-[15px]">
                                                        <!-- SADECE İLK OBJENİN, 2 SATIRI GÖRÜNMEKTEDİR. -->
                                                        <div class="text-editor !max-w-full editor-p:text-[18px] editor-li:text-[18px] md:editor-p:text-[18px] md:editor-li:text-[18px] sm:editor-p:text-[16px] sm:editor-li:text-[16px] xs:editor-p:text-[14px] xs:editor-li:text-[14px] [&_>*]:hidden [&_>*:first-child]:line-clamp-2">
                                                            <!-- Stylelar tasarımı yansıtmak adına eklenmiştir. / Backendde silinerek panel editörü üzerinden eklenmeli. -->
                                                            <p style="color: #676767;"><?= mb_substr(strip_tags($item['description']), 0, 100) ?>...</p>
                                                        </div>
                                                    </div>
                                                    <div class="button-field mt-[50px] 2xl:mt-[40px] xl:mt-[30px] lg:mt-[20px]">
                                                        <a href="<?= $item['seo_url'] ?>" class="button group/button w-fit min-w-[185px] h-[50px] md:h-[50px] flex justify-center items-center gap-[10px] px-[30px] rounded-none bg-main-500 relative duration-350 overflow-hidden hover:bg-main-600 sm:w-full">
                                                            <span class="text text-[16px] flex items-center text-white relative z-10 leading-tight duration-350 group-hover/button:text-white">View</span>
                                                            <i class="icon icon-chevron-right text-[8px] h-[8px] text-white leading-none flex items-center relative z-10 duration-350 group-hover/button:text-white group-hover/button:translate-x-[4px] rtl:rotate-180 rtl:group-hover/button:translate-x-[-4px]"></i>
                                                        </a>
                                                    </div>
                    ...
                    <div class="carousel-field relative blog-carousel-field z-60 py-[60px] xl:py-[45px] lg:py-[30px] md:py-0">
                        <div class="blog-image-carousel swiper !overflow-visible !pointer-events-none">
                            <div class="swiper-wrapper">
                                <!-- SLIDER YAPISININ STABİL ÇALIŞABİLMESİ İÇİN, EN AZ 6 ADET İÇERİK GİRİLMESİ TAVSİYE EDİLİR. -->
                                <?php foreach ($blog as $key => $item) : ?>
                                    <div class="swiper-slide group/slide pointer-events-none opacity-0 duration-350 transition-opacity [&.swiper-slide-active]:pointer-events-auto [&.swiper-slide-next]:pointer-events-auto [&.swiper-slide-next+&.swiper-slide]:pointer-events-auto [&.swiper-slide-active]:opacity-100 [&.swiper-slide-next]:opacity-100 [&.swiper-slide-next+&.swiper-slide]:opacity-100 [&.swiper-slide-active]:scale-100 [&.swiper-slide-next]:scale-100 [&.swiper-slide-next+&.swiper-slide]:scale-100
                                        ">
                                        <div class="content relative">
                                            <div class="image-field relative translate-z-0 aspect-[490/525] md:aspect-video overflow-hidden">
                                                <a href="<?= $item['seo_url'] ?>" class="image w-full h-full overflow-hidden translate-z-0 group/link">
                                                    <img src="<?= env('HTTP_DOMAIN') . '/' . getFolder(['uploads_folder', 'blog_images_folder'], $item['lang']) . '/' . $item['image'] ?>" class="full-cover duration-350 group-hover/link:scale-105" alt="">
                                                </a>
                                            </div>
                                            <div class="text-field flex flex-col gap-[15px] mt-[20px] lg:mt-[15px] duration-350 min-md:group-[&.swiper-slide-active]/slide:opacity-0 min-md:group-[&.swiper-slide-active]/slide:pointer-events-none min-md:group-[&.swiper-slide-prev]/slide:opacity-0 min-md:group-[&.swiper-slide-prev]/slide:pointer-events-none">
                                                <div class="date-field items-center gap-[10px] hidden md:flex">
                                                    <i class="icon icon-calendar text-[16px] h-[16px] text-main-500 block leading-none duration-350"></i>
                                                    <span class="text text-[15px] text-[#9A9A9A] font-medium leading-tight tracking-[0.02rem] duration-350 group-hover/slide:text-main-500"><?= date('j F Y', strtotime($item['created_at'])) ?></span>
                                                </div>
                                                <a href="<?= $item['seo_url'] ?>" class="title text-[22px] md:text-[20px] sm:text-[18px] xs:text-[16px] text-[#676767] leading-tight font-medium duration-350 hover:text-main-500"><?= mb_substr( $item['description'], 0, 50) ?>...</a>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                        ...
                        <div class="carousel-controller md:mt-[20px]">
                            <div class="carousel-navigation flex justify-center gap-[20px] md:gap-[15px] sm:gap-[10px] pointer-events-none z-20 min-md:absolute bottom-[60px] xl:bottom-[45px] lg:bottom-[30px] md:bottom-0 left-[60px] 2xl:left-[50px] xl:left-[40px] lg:left-[30px] md:left-0 md:justify-start rtl:left-auto rtl:right-[60px] 2xl:rtl:right-[50px] xl:rtl:right-[40px] lg:rtl:right-[30px] md:rtl:right-0">
                                <div class="blog-image-prev cursor-pointer pointer-events-auto duration-350 [&.swiper-button-disabled]:opacity-50 [&.swiper-button-disabled]:pointer-events-none group/nav-selector rtl:rotate-180">
                                    <div class="icon group/navigation flex items-center justify-center duration-350">
                                        <i class="icon-arrow-left text-main-500 text-[45px] h-[45px] sm:text-[25px] sm:h-[25px] flex items-center justify-center group-[&.swiper-button-disabled]/nav-selector:text-[#676767] group-hover/navigation:text-main-500 duration-350 group-hover/navigation:translate-x-[-3px]"></i>
                                    </div>
                                </div>
                                <div class="blog-image-next cursor-pointer pointer-events-auto duration-350 [&.swiper-button-disabled]:opacity-50 [&.swiper-button-disabled]:pointer-events-none group/nav-selector rtl:rotate-180">
                                    <div class="icon group/navigation flex items-center justify-center duration-350">
                                        <div class="icon-arrow-right text-main-500 text-[45px] h-[45px] sm:text-[25px] sm:h-[25px] flex items-center justify-center group-[&.swiper-button-disabled]/nav-selector:text-[#676767] group-hover/navigation:text-main-500 duration-350 group-hover/navigation:translate-x-[3px]"></div>
                                    </div>
                                </div>
...
@section('scripts')
    <script>
        ...
        if (document.querySelector('.homepage-carousel')) {
            let homepageCarousel = new Swiper(".homepage-carousel", {
                modules: [A, P, N],
                slidesPerView: 1,
                speed: 1000,
                spaceBetween: 30,
            ...
            // ------------------------------------------------------------------
            let homepageImageCarousel = new Swiper(".homepage-image-carousel", {
                modules: [EC],
                slidesPerView: 1,
                speed: 1000,
                spaceBetween: 30,
            ...
            homepageCarousel.on('slideChange', function() {
                homepageImageCarousel.slideTo(homepageCarousel.realIndex);
            });

            let carouselSection = document.querySelector('.carousel-section');
            let homepageCarouselWrapper = carouselSection.querySelector('.carousel-section .homepage-carousel-wrapper');
            let homepageImageCarouselField = document.querySelector('.carousel-section .homepage-image-carousel-field');
            let scrollWrapper = document.querySelector('.scroll-wrapper');
            let homepageCarouselRemainWidth = (carouselSection.offsetWidth - homepageCarouselWrapper.offsetWidth) / 2;

            if (window.innerWidth > 1024) {
                homepageImageCarouselField.style.width = "calc(100% + " + homepageCarouselRemainWidth + "px)";
                scrollWrapper.style.left = "+" + homepageCarouselRemainWidth / 2 + "px";
            }
    ...
    <script>
        ...
        let aboutIconableField = aboutSection.querySelector('.about-iconable-field');
        let aboutSectionBackground = aboutSection.querySelector('.about-background');
        let aboutIMGField = aboutSection.querySelector('.about-image-field');
        let aboutWrapper = aboutSection.querySelector('.wrapper');
        let aboutRemainWidth = (aboutSection.offsetWidth - aboutWrapper.offsetWidth) / 2;

        if (window.innerWidth > 1024) {
            aboutSectionBackground.style.width = "calc(100% + " + aboutRemainWidth + "px)";
        } else {
            aboutSectionBackground.style.width = "calc(100% + " + aboutRemainWidth + 30 + "px)";
            aboutSectionBackground.style.left = "-" + aboutRemainWidth + "px";
        }
        aboutIMGField.style.width = "calc(100% + " + aboutRemainWidth + "px)";

        aboutIMGField.style.maxHeight = document.querySelector('.about-inner-wrapper').offsetHeight + "px";
        aboutIMGField.style.maxWidth = document.querySelector('.about-image-field-fixer').offsetWidth + aboutRemainWidth + "px";
        aboutIMGField.style.right = "-" + aboutRemainWidth + "px";

        let homepageTextWrapper = document.querySelectorAll('.homepage-text-wrapper');
        let homepageIMGWrapper = document.querySelectorAll('.homepage-image-wrapper');
        let carouselPagination = document.querySelector('.carousel-controller-content');
        let scrollWrapperPagination = document.querySelector('.scroll-wrapper-pagination');

        if (window.innerWidth > 1680) {
            aboutSection.style.marginTop = "-" + (aboutIconableField.offsetHeight + 70) + "px";
            homepageTextWrapper.forEach((item, index) => {
                item.style.paddingBottom = "calc(" + (aboutIconableField.offsetHeight + 70 + 45) + "px)";
            });
            homepageIMGWrapper.forEach((item, index) => {
                item.style.paddingBottom = "calc(" + (aboutIconableField.offsetHeight + 70) + "px)";
            });
            carouselPagination.style.paddingBottom = "calc(" + (aboutIconableField.offsetHeight + 70 + 50) + "px)";
        } else if (window.innerWidth > 1440) {
            aboutSection.style.marginTop = "-" + (aboutIconableField.offsetHeight + 60) + "px";
            homepageTextWrapper.forEach((item, index) => {
                item.style.paddingBottom = "calc(" + (aboutIconableField.offsetHeight + 60 + 45) + "px)";
            });
            homepageIMGWrapper.forEach((item, index) => {
                item.style.paddingBottom = "calc(" + (aboutIconableField.offsetHeight + 60) + "px)";
            });
            carouselPagination.style.paddingBottom = "calc(" + (aboutIconableField.offsetHeight + 60 + 40) + "px)";
            scrollWrapperPagination.style.bottom = "calc(" + (aboutIconableField.offsetHeight + 60 + 40) + "px)";
        } else if (window.innerWidth > 1280) {
            aboutSection.style.marginTop = "-" + (aboutIconableField.offsetHeight + 45) + "px";
            homepageTextWrapper.forEach((item, index) => {
                item.style.paddingBottom = "calc(" + (aboutIconableField.offsetHeight + 45 + 30 + 30 + 45) + "px)";
            });
            homepageIMGWrapper.forEach((item, index) => {
                item.style.paddingBottom = "calc(" + (aboutIconableField.offsetHeight + 45) + "px)";
            });
            carouselPagination.style.paddingBottom = "calc(" + (aboutIconableField.offsetHeight + 45 + 30) + "px)";
            scrollWrapperPagination.style.bottom = "calc(" + (aboutIconableField.offsetHeight + 45 + 30) + "px)";
        } else if (window.innerWidth > 1024) {
            aboutSection.style.marginTop = "-" + (aboutIconableField.offsetHeight + 30) + "px";
            homepageTextWrapper.forEach((item, index) => {
                item.style.paddingBottom = "calc(" + (aboutIconableField.offsetHeight + 30 + 45) + "px)";
            });
            homepageIMGWrapper.forEach((item, index) => {
                item.style.paddingBottom = "calc(" + (aboutIconableField.offsetHeight + 30) + "px)";
            });
            carouselPagination.style.paddingBottom = "calc(" + (aboutIconableField.offsetHeight + 30 + 20) + "px)";
        } else {
            // aboutSection.style.marginTop = "-" + (aboutIconableField.offsetHeight + 30) + "px";
            // homepageTextWrapper.forEach((item, index) => {
            //     item.style.paddingBottom = "calc(" + (aboutIconableField.offsetHeight + 30) + "px)";
    ...
    <script>
        // PRODUCTS
        // ------------------------------------------------------------------
        let homepageProductTabSelector = document.querySelector('#homepage-product-tab-selector');
        let productListWrapper = document.querySelectorAll('.product-list-wrapper');
        let productListWrapperMobile = document.querySelectorAll('.mobile-view-product');

        productListWrapper[0].classList.add('is-active');

        homepageProductTabSelector.addEventListener('change', () => {
            productListWrapperMobile.forEach((item, index) => {
                item.classList.remove('is-active');
            });
            productListWrapperMobile[homepageProductTabSelector.selectedIndex].classList.add('is-active');

            productListWrapper.forEach((item, index) => {
                item.classList.remove('is-active');
            });
            productListWrapper[homepageProductTabSelector.selectedIndex].classList.add('is-active');
        });

        let mobileViewProduct = document.querySelectorAll('.mobile-view-product');

        mobileViewProduct[0].classList.add('is-active');
        // MULTIPLE CAROUSEL USAGE SAMPLE
        // ------------------------------------------------------------------
        if (document.querySelector('.homepage-product-carousel')) {
            let i;
            const homepageProductSlider = document.querySelectorAll('.homepage-product-carousel');

            const homepageProductPrev = document.querySelectorAll('.homepage-product-prev');
            const homepageProductNext = document.querySelectorAll('.homepage-product-next');

            for (i = 0; i < homepageProductSlider.length; i++) {
                homepageProductSlider[i].classList.add('homepage-product-carousel-' + i);
                homepageProductPrev[i].classList.add('homepage-product-prev-' + i);
                homepageProductNext[i].classList.add('homepage-product-next-' + i);

                let homepageProductSwiper = new Swiper(".homepage-product-carousel", {
                    modules: [A, P, N, Px],
                    slidesPerView: 1,
                    speed: 1000,
                    spaceBetween: 30,
                    ...
                    navigation: {
                        nextEl: '.homepage-product-next-' + i,
                        prevEl: '.homepage-product-prev-' + i,
                    },
                });
            }
        }
    ...
    <script>
        // PROJECTS
        // ------------------------------------------------------------------
        let mapField = document.querySelector('.map-field');
        let worldMapField = document.querySelector('.world-map-field');
        let worldMapSVG = document.querySelector('.world-map-svg');
        let worldMapPATH = worldMapSVG.querySelectorAll('path');
        let worldMapPIN = document.querySelectorAll('.world-map-pin');
        let popupProjectWrapperStyles = document.querySelector('.popup-project-wrapper');
        let mapSelector = document.querySelector('#map-selector');

        popupProjectWrapperStyles.style.maxHeight = `calc(100vh - ${document.querySelector('.popup-project-title-field').offsetHeight}px - 120px - 120px - 60px)`;

        mapSelector.addEventListener('change', () => {
            let index = mapSelector.selectedIndex;
            let selectedIndex = mapSelector.options[index].getAttribute('data-id');
            worldMapPIN.forEach((pin, index) => {
                pin.classList.remove('is-active');
            });
            if (selectedIndex < 10) {
                worldMapPIN[selectedIndex].classList.add('is-active');
                worldMapPIN[selectedIndex].click();
            }

            worldMapPATH.forEach((path, pathIndex) => {
                path.classList.remove('is-active');
            });
            worldMapPATH.forEach((path, pathIndex) => {
                let arrayIndex = path.getAttribute('data-index');
        ...
        function popupProjectFunction(item) {
            let id = item.getAttribute('data-content-id');
            let popupProjectWrapper = document.querySelector('.popup-project-wrapper');

            worldMapPATH.forEach((item, index) => {
                let arrayIndex = item.getAttribute('data-index');
                worldMapPATH.forEach((path, pathIndex) => {
                    path.classList.remove('is-active');
                });
                worldMapPATH.forEach((path, pathIndex) => {
                ...
                document.querySelectorAll('.filter-item').forEach((filterItem, filterIndex) => {
                    filterItem.classList.remove('is-active');
                });
                document.querySelectorAll('.filter-item.selectable')[id].classList.add('is-active');

                worldMapPIN.forEach((pin, index) => {
                    pin.classList.remove('is-active');
                });
                worldMapPIN[id].classList.add('is-active');
            });
        }

        function allCountry(item) {
            worldMapPATH.forEach((path, index) => {
                path.classList.remove('is-active');
            });
            worldMapPIN.forEach((pin, index) => {
                pin.classList.remove('is-active');
        ...
        function filterItemFunction(item) {
            let index = item.getAttribute('data-content-id');
            worldMapPIN.forEach((pin, index) => {
                pin.classList.remove('is-active');
            });
            worldMapPIN[index].classList.add('is-active');
        ...
        function worldMapPathFunc(item) {
            let arrayIndex = item.getAttribute('data-index');
            if (arrayIndex) {
                worldMapPATH.forEach((path, index) => {
                    path.classList.remove('is-active');
                ...
                document.querySelectorAll('.filter-item').forEach((filterItem, index) => {
                    filterItem.classList.remove('is-active');
                });
                document.querySelectorAll('.filter-item.selectable')[arrayIndex].classList.add('is-active');

                worldMapPIN.forEach((pin, index) => {
                    pin.classList.remove('is-active');
                });
                worldMapPIN[arrayIndex].classList.add('is-active');
                worldMapPIN[arrayIndex].click();
            }
        }
        ...
        function zoomINFunction() {
            mapField.querySelector('.world-map-field').classList.add('is-zoom');

            for (let i = 0; i <= maxZoomLevel; i++) {
                if (mapField.querySelector('.world-map-field').classList.contains(`zl-${i}`)) {
                    mapField.querySelector('.world-map-field').classList.remove(`zl-${i}`);
                    mapField.querySelector('.world-map-field').classList.add(`zl-${i+1}`);
                    currentZoomLevel = currentZoomLevel + 1;
                    zoomIN.classList.add('is-disabled');
                    zoomOUT.classList.add('is-disabled');

                    mapField.querySelector('.world-map-field').style.width = `calc(100% + ${zoomCurrency}%)`;
                    mapField.querySelector('.world-map-field').style.height = `calc(100% + ${zoomCurrency}%)`;
                    zoomCurrency += zoomPlus;
            ...
            mapDrag = Draggable.create('.world-map-field', {
                bounds: ".map-field",
                type: "x, y",
                activeCursor: true,
                inertia: true,
        ...
        function zoomOUTFunction() {
            ...
            for (let i = 0; i <= maxZoomLevel; i++) {
                if (mapField.querySelector('.world-map-field').classList.contains(`zl-${i}`)) {
                    ...
                    mapField.querySelector('.world-map-field').style.width = `calc(${mapField.querySelector('.world-map-field').style.width} - ${zoomMinus}%)`;
                    mapField.querySelector('.world-map-field').style.height = `calc(${mapField.querySelector('.world-map-field').style.height} - ${zoomMinus}%)`;
                    ...
                    if (currentZoomLevel == 0) {
                        mapField.querySelector('.world-map-field').style.width = `calc(100%)`;
                        mapField.querySelector('.world-map-field').style.height = `calc(100%)`;
                        gsap.to('.world-map-field', {
                            delay: 0.225,
                            duration: 0.45,
                            xPercent: -50,
    ...
    <script>
        // BLOG
        // ------------------------------------------------------------------
        if (document.querySelector('.blog-text-carousel')) {

            let blogCarouselSection = document.querySelector('.blog-section');
            let blogCarouselWrapper = document.querySelector('.blog-section .blog-wrapper');
            let blogCarouselField = document.querySelector('.blog-carousel-field');
            let blogTextBackground = document.querySelector('.blog-text-background');
            let blogCarouselRemainWidth = (blogCarouselSection.offsetWidth - blogCarouselWrapper.offsetWidth) / 2;

            if (window.innerWidth > 1024) {
                if (document.querySelector('html').getAttribute('dir') == 'ltr') {
                    blogCarouselField.style.width = "calc(100% + " + blogCarouselRemainWidth + "px)";
                    blogTextBackground.style.width = "calc(100% + " + blogCarouselRemainWidth + "px)";
                    blogTextBackground.style.left = "-" + blogCarouselRemainWidth + "px";
                } else {
                    blogCarouselField.style.width = "calc(100% + " + blogCarouselRemainWidth + "px)";
                    blogTextBackground.style.width = "calc(100% + " + blogCarouselRemainWidth * 2 + "px)";
                    blogTextBackground.style.left = "-" + blogCarouselRemainWidth + "px";
                }
            }
            ...
            // BLOG TEXT CAROUSEL
            // ------------------------------------------------------------------
            let blogTextCarousel = new Swiper(".blog-text-carousel", {
                modules: [A, Px],
                slidesPerView: 1,
                speed: 1000,
                spaceBetween: 30,
            ...
            // BLOG IMAGE CAROUSEL
            // ------------------------------------------------------------------
            let blogImageCarousel = new Swiper(".blog-image-carousel", {
                modules: [A, N],
                slidesPerView: 1,
                speed: 1000,
                spaceBetween: 30,
            ...
            blogImageCarousel.on('slideChange', function() {
                blogTextCarousel.slideTo(blogImageCarousel.realIndex);
            });

            // PAUSE ON MOUSE ENTER
            blogImageCarousel.autoplay.stop();
            let blogSection = document.querySelector('.blog-section');
            let blogImageSlide = document.querySelectorAll('.blog-image-carousel .swiper-slide');
            if (window.innerWidth > 1024) {
                blogSection.addEventListener('mouseenter', function() {
                    blogImageCarousel.autoplay.stop();
                });
                blogSection.addEventListener('mouseleave', function() {
                    blogImageCarousel.autoplay.start();
                });

                blogImageSlide.forEach(function(item, index) {
                    gsap.to(item, {
                        scrollTrigger: {
                            trigger: item,
