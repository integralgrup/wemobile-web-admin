                                    ...
                                    <div class="card-body" style="display:grid; grid-template-columns: 1fr 1fr; gap: 20px;">    
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="page_type_{{$menu->lang}}" id="page_type_{{$menu->lang}}" class="form-select">
                                                ...
                                                <option value="market" {{ $menu->page_type == 'market' ? 'selected' : '' }}>Market</option>
                                                        ...
                                                        @foreach($parentMenu->children as $childMenu)
                                                            ...
                                                            @if($childMenu->children)
                                                                @foreach($childMenu->children as $childMenu2)
                                                                    <option value="{{ $childMenu2->menu_id }}" {{ $childMenu2->menu_id == $menu->parent_menu_id ? 'selected' : '' }}>---- {{ $childMenu2->title }}</option>
                                                                @endforeach
                                                            @endif
                                                        @endforeach
                                                    @endif
