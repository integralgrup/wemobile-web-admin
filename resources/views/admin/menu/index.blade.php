                                    ...
                                    @foreach($child->children as $subChild)
                                        ...
                                        @if($subChild->children)
                                          @foreach($subChild->children as $subChild2)
                                            <tr  data-id="{{$subChild2->menu_id}}" class="child-row">
                                              <td>
                                                <i class="bi bi-list"></i>
                                              </td>
                                              <td> <!-- bullet icon--> 
                                              ...
                                              <td>
                                                <a href="{{ route('admin.menu.edit', $subChild2->menu_id) }}" class="btn btn-primary btn-sm">Düzenle</a>
                                                <form action="{{ route('admin.menu.destroy', $subChild2->menu_id) }}" method="POST" style="display:inline;">
                                                  @csrf
                                                  @method('DELETE')
                                                  <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Bu içeriği silmek istediğinize emin misiniz?')">Sil</button>
                                                </form>
