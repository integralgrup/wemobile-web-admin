                                    ...
                                    <div class="card-body" style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if(isset($image[$language->lang_code]))
                                                <img src="{{ $languages[0]->domain .'/'. getFolder(['uploads_folder', 'project_images_folder'], $language->lang_code) . '/' . $image[$language->lang_code] }}" alt="{{ $alt[$language->lang_code] ?? '' }}" class="img-thumbnail mt-2" width="100">
