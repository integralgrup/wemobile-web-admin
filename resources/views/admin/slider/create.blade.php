                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="tab-{{ $language->id }}" role="tabpanel" aria-labelledby="tab-{{ $language->id }}-tab">
                                    <div class="card-body" style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                                        ...
                                        <div class="mb-3">
                                            <label for="slide_title_{{ $language->lang_code }}" class="form-label">Üst Başlık ({{ strtoupper($language->lang_code) }})</label>
                                        ...
                                        <!-- button_title -->
                                        <div class="mb-3">
                                            <label for="button_title_{{ $language->lang_code }}" class="form-label">Buton Text ({{ strtoupper($language->lang_code) }})</label>
