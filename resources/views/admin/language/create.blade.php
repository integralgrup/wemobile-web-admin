                            ...
                            <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                                <form action="{{ route('admin.language.store') }}" method="POST" enctype="multipart/form-data">
                                    <div class="card-body" style="display:grid; grid-template-columns: repeat(4, 1fr); gap: 20px;">
                                        ...
                                        <!-- Brand URL -->
                                        <div class="mb-2">
                                            <label for="market_url" class="form-label">Market URL <span class="text-danger">*</span></label>
                                            <input type="text" name="market_url" id="market_url" class="form-control" maxlength="255" required>
                                        </div>
                                        ...
                                        <!-- Brand Images Folder -->
                                        <div class="mb-2">
                                            <label for="market_images_folder" class="form-label">Market Görseller Klasörü <span class="text-danger">*</span></label>
                                            <input type="text" name="market_images_folder" id="market_images_folder" class="form-control" maxlength="255" required>
                                        </div>
