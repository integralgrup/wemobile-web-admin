                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.language.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body" style="display:grid; grid-template-columns: repeat(4, 1fr); gap: 20px;">
                            ...
                            <div class="mb-2">
                                <label for="market_url" class="form-label">Market URL</label>
                                <input type="text" class="form-control" id="market_url" name="market_url" value="{{ $language->market_url }}" required>
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                <label for="market_images_folder" class="form-label">Market Görseller Klasörü</label>
                                <input type="text" class="form-control" id="market_images_folder" name="market_images_folder" value="{{ $language->market_images_folder }}" required>
                            </div>
                            <div class="mb-2">
